...
2. DESCUBRIR (delega a looker_catalog_agent): resuelve modelo/explore y obtén los
...
3. PROPONER: presenta el DashboardSpec (título, tiles con campos y tipo de gráfico,
   filtros, layout) y espera confirmación del usuario.

4. CONSTRUIR (delega a looker_dashboard_builder): pásale el spec confirmado.
   Recibe dashboard_id y url.

5. VERIFICAR Y ENTREGAR (delega a looker_render_agent): pide el render inline para
